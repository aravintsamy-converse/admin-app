...
import CalenderIcon from '@/components/client/icons/CalenderIcon'
import {
  CalendarNavLeft,
  CalendarNavRight,
                ...
                <PopoverTrigger asChild>
                  <FormControl>
                    <Button
                      ...
                      className={cn(
                        'text-selectedValue  outline-none cursor-pointer  3xl:w-[508px] !mt-[6px] pl-[14px]  h-[35px]  border-border   justify-between rounded-sm   shadow-none transition-all duration-200 hover:border-primary hover:text-selectedValue  font-normal text-sm border  hover:bg-background',
                  ...
                  {mode === 'day' && (
                    <Calendar
                      ...
                      classNames={{
                        ...
                        caption_label:
                          'text-primary font-bold text-[15px] cursor-pointer ',
                        cell: 'flex h-[22px] w-[32px] ',
                        head_cell:
                          'text-primary rounded-md w-8 font-medium text-[14px]',
                        day: cn(
                          buttonVariants({ variant: 'ghost' }),
                          'h-[28px] w-[26px] p-0  text-muted-foreground hover:shadow-customhover font-normal text-[14px] rounded-sm hover:bg-background   '
                        ),
                      }}
                      formatters={{
                        formatCaption: (date) => (
