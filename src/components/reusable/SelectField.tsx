            ...
            <FormControl className="">
              ...
              >
                <SelectTrigger
                  ...
                  className={`3xl:w-[508px] !mt-[6px]  pl-[14px] h-[35px]  text-selectedValue focus:outline-none  text-sm font-normal rounded-sm hover:border-primary shadow-none border  ${open ? 'border-primary' : 'border-border'}   hover:bg-background `}
                >
                  <SelectValue
